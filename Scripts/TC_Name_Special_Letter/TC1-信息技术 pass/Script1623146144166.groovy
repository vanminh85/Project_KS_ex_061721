...
WebUI.click(findTestObject('Object Repository/Page_Demo AUT/td_15'))
...
WebUI.setText(findTestObject('Object Repository/Page_Demo AUT/textarea_Comment_comment'), '123')

WebUI.rightClick(findTestObject('Object Repository/Page_Demo AUT/textarea_Comment_comment'))

WebUI.setText(findTestObject('Object Repository/Page_Demo AUT/textarea_Comment_comment'), 'bc')
