...
WebUI.click(findTestObject('Object Repository/Page_The World Clock  Worldwide/span_Nha Trang'))

WebUI.navigateToUrl('https://www.timeanddate.com/worldclock/vietnam/nha-trang')

WebUI.click(findTestObject('Object Repository/Page_Current Local Time in Nha Trang, Vietnam/a_Vietnam'))
...
WebUI.takeScreenshotAsCheckpoint('sample visual testing')
